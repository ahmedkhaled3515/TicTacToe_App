...
public class OnlineGameboard extends AnchorPane {
    ...
    static Vector<OnlineGameboard> clientsVector=new Vector<OnlineGameboard>();
    ...
    public OnlineGameboard(Stage stage){
        ...
        email = msg.getEmail();
        opponentEmail = msg.getOpponentEmail();
            ...
            public void handle(ActionEvent event) {
                ...
                Platform.runLater(()->{
                    ...
                    if(button0Flag==true){
                        ...
                        if(currentPlayer==email){ //Player1
                            msg.setButtonPressed("topLeftBtn");                                   
                            msg.setCurrentPlayer("player1");
                            msg.setSymbol("x");
                            
                            writeObjectsToFile(msg, filePath);

                            currentPlayer = (currentPlayer.equals(currentPlayer)) ? opponentEmail : email;


                        }else{ //player2
                            msg.setButtonPressed("topLeftBtn");                                  
                            msg.setCurrentPlayer("player2");
                            msg.setSymbol("o");
                            writeObjectsToFile(msg, filePath);
 
                            currentPlayer=(currentPlayer.equals(currentPlayer)) ?  email : opponentEmail;
                        }
