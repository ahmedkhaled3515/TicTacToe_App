...
public class RecordHistory extends AnchorPane {
    ...
    .add("/tictactoe/RecordHistory/fxml.css");
    ...
    backgroundImg.setFitHeight (

    690.0);
    backgroundImg.setFitWidth (

    1000.0);
    backgroundImg.setImage (

    new Image(getClass().getResource("/assets/images/background.jpg").toExternalForm()));

    availableLabel.setLayoutX (

    500.0);
    availableLabel.setLayoutY (
